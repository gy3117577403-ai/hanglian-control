...
export const PERMISSIONS = {
  ...
  SETTINGS_DICTIONARY_VIEW: 'settings.dictionary.view',
  SETTINGS_DICTIONARY_UPDATE: 'settings.dictionary.update',
  SETTINGS_STATION_VIEW: 'settings.station.view',
  SETTINGS_STATION_UPDATE: 'settings.station.update',
  SETTINGS_DISPLAY_VIEW: 'settings.display.view',
  SETTINGS_DISPLAY_UPDATE: 'settings.display.update',
  SETTINGS_ANNOUNCEMENT_VIEW: 'settings.announcement.view',
  SETTINGS_ANNOUNCEMENT_UPDATE: 'settings.announcement.update',
  SETTINGS_FEEDBACK_CREATE: 'settings.feedback.create',
  SETTINGS_FEEDBACK_VIEW: 'settings.feedback.view',
  SETTINGS_FEEDBACK_RESOLVE: 'settings.feedback.resolve',
  SETTINGS_PILOT_CHECK_VIEW: 'settings.pilot_check.view',
  SETTINGS_PILOT_CHECK_RUN: 'settings.pilot_check.run',
  ADMIN_ALL: 'admin.all',
...
export const permissionLabels: Record<Permission, string> = {
  ...
  'settings.view': '查看系统配置',
  'settings.update': '维护系统配置',
  'settings.dictionary.view': '查看字典配置',
  'settings.dictionary.update': '维护字典配置',
  'settings.station.view': '查看工位配置',
  'settings.station.update': '维护工位配置',
  'settings.display.view': '查看显示配置',
  'settings.display.update': '维护显示配置',
  'settings.announcement.view': '查看公告通知',
  'settings.announcement.update': '维护公告通知',
  'settings.feedback.create': '提交使用反馈',
  'settings.feedback.view': '查看使用反馈',
  'settings.feedback.resolve': '处理使用反馈',
  'settings.pilot_check.view': '查看试运行检查',
  'settings.pilot_check.run': '运行试运行检查',
