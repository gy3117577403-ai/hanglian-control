...
建议用安卓平板按 `docs/tablet-field-test-guide.md` 和应用内“冻结前验收”完整走查 V1.8 演示冻结候选版，通过后可选择 push 分支、创建 PR、合并 main / 打 `v1.8-demo-candidate` 标签，或继续做下一轮 UI 微调。
