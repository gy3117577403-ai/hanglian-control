...
requireText('apps/tablet/src/config/app-version.ts', "APP_VERSION = 'V2.3'", 'APP_VERSION V2.3');
requireText('apps/tablet/src/config/app-version.ts', "APP_STAGE = '现场知识库演示版'", 'APP_STAGE 现场知识库演示版');
requireText('apps/tablet/src/config/app-version.ts', "APP_BUILD_CHANNEL = 'mock-local-knowledge-demo'", 'mock-local-knowledge-demo');
