...
requireIncludes('apps/tablet/src/config/app-version.ts', "APP_VERSION = 'V2.7'", '版本信息不是 V2.7。');
requireIncludes('apps/tablet/src/config/app-version.ts', "APP_BUILD_CHANNEL = 'mock-local-full-regression-candidate'", '构建通道不是 V2.7 回归候选通道。');
...
if (!currentBranch().includes('v2-7')) warnings.push(`当前分支不是 V2.7 命名：${currentBranch()}`);
